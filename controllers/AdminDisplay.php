...
/**
 * Render sticker administration pages.
 *
 * @author Huhani (mmia268@gmail.com)
 */

class AdminDisplay extends Sticker
{
	...
	public function dispStickerAdminStickerList(){
	...
	public function dispStickerAdminStickerView(){
	...
	public function dispStickerAdminBuyList(){
		$search_target = Context::get('search_target');
		$search_keyword = Context::get('search_keyword');
	...
	public function dispStickerAdminBuyInfo(){
		$idx = Context::get('idx');
	...
	public function dispStickerAdminLogList(){
		$search_target = Context::get('search_target');
		$search_keyword = Context::get('search_keyword');
	...
	public function dispStickerAdminGifConversionLog()
	{
		...
		Context::set('is_ffmpeg', ImageProcessor::isFfmpegAvailable());
	...
	public function dispStickerAdminLogInfo(){
		$idx = Context::get('idx');
	...
	public function dispStickerAdminConfig(){
	...
	public function dispStickerAdminCategoryInfo(){
	...
	public function dispStickerAdminGrantInfo(){
	...
	public function dispStickerAdminDesign(){
	...
	public function dispStickerAdminSkinInfo() {
	...
	public function dispStickerAdminMobileSkinInfo() {
