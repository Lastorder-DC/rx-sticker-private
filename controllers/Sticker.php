...
/**
 * Handle public sticker actions and shared event logic.
 *
...
class Sticker extends Base
{
	...
	public function triggerBeforeUpdateComment(&$obj){
	...
	public function _replaceBlockedStickerImgInContent($content){
		if(!$content){
			return $content;
		}
	...
	public function _replaceBlockedStickerImgAnchorCallback($matches){
		$logged_info = Context::get('logged_info');
		$member_srl = $logged_info ? $logged_info->member_srl : 0;
	...
	public function stickerCommentCallback($matches){
	...
	public function procStickerCommentInsert(){

	}

	public function procStickerBuy(){
	...
	public function procStickerBuyOrderChange()
	{
		$sticker_srl = Context::get('sticker_srl');
	...
	public function procStickerFileDelete(){
	...
	public function procStickerDelete(){
		$logged_info = Context::get('logged_info');
		if(!$logged_info){
			return new BaseObject(-1,'msg_invalid_access');
		}
	...
	public function procStickerBuyDelete(){
	...
	public function procStickerGetStickerSrl() {
	...
	public function _replaceUndefinedStickerSrlInContent($content){
		if(!$content){
			return $content;
		}
	...
	public function _replaceUndefinedStickerSrlAnchorCallback($matches){
	...
	public function _extractStickerSrcFromImgTag($img_src){
		if(!$img_src){
			return '';
		}
	...
	public function _getStickerSrlByStickerSrc($sticker_src){
		if(!$sticker_src){
			return 0;
		}
	...
	public function procStickerBlockInsert(){
		$logged_info = Context::get('logged_info');
		if(!$logged_info){
			return new BaseObject(-1,'msg_invalid_access');
		}
	...
	public function procStickerBlockDelete(){
		$logged_info = Context::get('logged_info');
		if(!$logged_info){
			return new BaseObject(-1,'msg_invalid_access');
		}
	...
	public function procStickerInsert(){
	...
	public function _updateSticker($obj, $sticker){
	 ...
	 * @return bool|int
	 */
	public function _insertImage($sticker_srl, $file_srl, $uploaded_filename, $source_filename, &$file_count, $is_update = false)
	{
	 ...
	 * @return bool|int
	 */
	public function _updateImage($origin_obj, $file_srl, $uploaded_filename, $source_filename)
	{
	...
	public function _updateStickerFileInfo($sticker_file_srl, $file_srl, $file_name, $url, $no){
		$logged_info = Context::get('logged_info');
		if(!$logged_info){
			return false;
		}
	...
	public function updateReadedCount(&$oSticker){
	...
	public function _insertSickerFile($sticker_srl, $file_srl, $file_name, $url, $no){
		$logged_info = Context::get('logged_info');
		if(!$logged_info){
			return false;
		}
	...
	public function insertStickerLog($obj, $sequence = false){
		$logged_info = Context::get('logged_info');
	...
	public function _setBuyMemberPoint($sticker_member_srl, $member_srl, $price=0){
		$oPointController = PointController::getInstance();
	...
	public function _increaseStickerBuyCount($sticker_srl){
		$args = new stdClass();
		$args->sticker_srl = $sticker_srl;
	...
	public function _increaseStickerUsedCount($sticker_srl, $sticker_file_srl, $member_srl){
		$args = new stdClass();
		$args->sticker_srl = $sticker_srl;
	...
	public function _checkFakeSticker($sticker_srl, $sticker_file_srl, $member_srl){
		$oStickerModel = StickerModel::getInstance();
	...
	public function _checkUsableSticker($sticker_srl){
		$args = new stdClass();
		$args->sticker_srl = $sticker_srl;
		$output = executeQuery('sticker.getSticker', $args);
		if (!$output->toBool() || empty($output->data))	{
	...
	public function _checkDefaultSticker($sticker_srl){
		$oStickerModel = StickerModel::getInstance();
	...
	public function _insertStickerBlock($member_srl, $sticker_srl){
		$args = new stdClass();
	...
	public function _deleteStickerBlock($member_srl, $sticker_srl){
		$args = new stdClass();
		$args->member_srl = $member_srl;
		$args->sticker_srl = $sticker_srl;
	...
	public function _isBlockedSticker($member_srl, $sticker_srl){
	...
	public function _checkCorrectTag($tag){
	...
	public function _checkBuyStickerToday($member_srl = 0, $sticker_srl = 0){
		$args = new stdClass();
		$args->member_srl = $member_srl;
		$args->sticker_srl = $sticker_srl;
	...
	public function _checkStickerInContent($content){
	...
	public function _getStickerFile($sticker_srl, $no){
		$args = new stdClass();
		$args->sticker_srl = $sticker_srl;
		$args->no = $no;
	...
	public function _getStickerFileCount($sticker_srl){
		$args = new stdClass();
		$args->sticker_srl = $sticker_srl;
	...
	public function _getStickerBuyCount($member_srl){
		$args = new stdClass();
		$args->member_srl = $member_srl;
	...
	public function _getStickerComment($sticker_file_srl){
		$args = new stdClass();
		$args->sticker_file_srl = $sticker_file_srl;
	...
	public function _getStickerDeleteMsg(){
		$oStickerModel = StickerModel::getInstance();
		$module_config = $oStickerModel->getConfig();
		return $module_config->deleted_sticker;
	}

	public function _deleteSticker($sticker_srl){
		$args = new stdClass();
		$args->sticker_srl = $sticker_srl;
	...
	public function _deleteStickerFile($sticker_srl, $file_srl){
		$args = new stdClass();
		$args->sticker_srl = $sticker_srl;
		$args->file_srl = $file_srl;
	...
	public function _deleteStickerFiles($sticker_srl){ // file_parent_srl
		$oFileController = FileController::getInstance();
	...
	public function _deleteFile($file_srl){
		$oFileController = FileController::getInstance();
		$output = $oFileController->deleteFile($file_srl);
	}

	public function _deleteTemporaryFile($sticker_main, $sticker_file){

	}

	public function _updateFileStatus($sticker_srl){
		$args = new stdClass();
	...
	public function _deleteStickerFilesDB($sticker_srl){
		$args = new stdClass();
		$args->sticker_srl = $sticker_srl;
		executeQuery('sticker.deleteStickerFilesByStickerSrl', $args);
	}

	public function _deleteStickerBuyByStickerSrl($sticker_srl){
		$args = new stdClass();
		$args->sticker_srl = $sticker_srl;
		executeQuery('sticker.deleteStickerBuyByStickerSrl', $args);
	}

	public function _deleteStickerBuyByMemberSrl($member_srl, $sticker_srl){
		$args = new stdClass();
		$args->member_srl = $member_srl;
		$args->sticker_srl = $sticker_srl;
		$args->date = date("YmdHis");
